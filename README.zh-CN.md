...
<img src="docs/demo.gif" width="720" alt="Seeybot 演示" />
...
Seeybot 住在 Mac 的**刘海**里。一眼就能看到有多少个 AI 编程会话在运行、多少在**工作中**、多少**空闲**、烧了多少 token——还有一只会眨眼、东张西望、工作时叽叽喳喳的机器人。鼠标移上去，它会弹开成一个完整看板。
...
- [x] 更新检查
- [x] Homebrew cask
- [ ] 🔔 **会话完成弹窗提醒 —— _下一个重点_。** AI 工具跑完长任务往往不能第一时间通知你；Seeybot 将在会话从「工作中」变为空闲的瞬间弹窗提醒。
...
# 若用 Homebrew 安装：  brew uninstall --cask seeybot
```
