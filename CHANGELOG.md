...
All notable changes to Seeybot are documented here. This project follows
[Semantic Versioning](https://semver.org/) and its releases live on
[GitHub Releases](https://github.com/7757/Seeybot/releases).
...
- Animated **Seeybot** mascot (blink, glance, hop, antenna sway, sparkles, `zzz`).
...
- Install via Homebrew cask (`brew install --cask 7757/seeybot/seeybot`), a one-line
  script, or from source (`./install.sh`); auto-starts at login.
